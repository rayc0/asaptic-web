# visual_qa report — `before-http`

- Target: http://localhost:8931/demos/
- Run: 2026-08-09T18:31:55.882Z
...
|---|---|---|---|---|---|
| desktop-1280 | 0px | 0 | 5 | 0 | **FAIL** |
| tablet-768 | 0px | 0 | 5 | 0 | **FAIL** |
| mobile-390 | 0px | 0 | 5 | 0 | **FAIL** |
